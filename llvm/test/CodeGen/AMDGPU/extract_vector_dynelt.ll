...
; GCN-NEXT:    v_mov_b32_e32 v0, 0x3f847ae1
; GCN-NEXT:    v_mov_b32_e32 v1, 0x3ff028f5
; GCN-NEXT:    v_mov_b32_e32 v2, 0xc28f5c29
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NEXT:    v_mov_b32_e32 v1, 0x4000147a
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v1, s[0:1]
; GCN-NEXT:    v_mov_b32_e32 v1, 0x40100a3d
; GCN-NEXT:    s_cselect_b64 s[2:3], 1, 0
; GCN-NEXT:    v_cndmask_b32_e64 v1, v0, v1, s[2:3]
; GCN-NEXT:    v_mov_b32_e32 v0, 0x47ae147b
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
; GCN-NEXT:    v_mov_b32_e32 v2, 0xe147ae14
...
; GCN-NEXT:    s_load_dword s4, s[0:1], 0x2c
; GCN-NEXT:    v_mov_b32_e32 v0, 0x47ae147b
; GCN-NEXT:    v_mov_b32_e32 v1, 0xc28f5c29
; GCN-NEXT:    v_mov_b32_e32 v2, 0x3ff028f5
; GCN-NEXT:    v_mov_b32_e32 v3, 0x70a3d70a
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_cmp_eq_u32 s4, 1
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
...
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GCN-NEXT:    s_cselect_b64 s[0:1], 1, 0
; GCN-NEXT:    v_mov_b32_e32 v1, 0xe147ae14
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v1, s[0:1]
; GCN-NEXT:    v_mov_b32_e32 v1, 0x3f847ae1
; GCN-NEXT:    s_cmp_eq_u32 s4, 3
; GCN-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc
; GCN-NEXT:    v_mov_b32_e32 v2, 0x4000147a
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
; GCN-NEXT:    s_cmp_eq_u32 s4, 4
; GCN-NEXT:    v_cndmask_b32_e64 v1, v1, v2, s[0:1]
; GCN-NEXT:    v_mov_b32_e32 v2, 0x40100a3d
; GCN-NEXT:    s_cselect_b64 s[0:1], 1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc
; GCN-NEXT:    v_mov_b32_e32 v2, 0x40140a3d
...
; GCN-NEXT:    s_lshr_b64 s[0:1], s[2:3], s0
...
; GCN-NEXT:    s_cmp_lg_u32 s4, 2
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
; GCN-NEXT:    v_cndmask_b32_e64 v0, 1, 2, s[0:1]
; GCN-NEXT:    s_cmp_lg_u32 s4, 3
...
; GCN-NEXT:    s_cmp_lg_u32 s4, 2
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
; GCN-NEXT:    v_cndmask_b32_e64 v1, 1.0, 2.0, s[0:1]
; GCN-NEXT:    s_cmp_lg_u32 s4, 3
; GCN-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
; GCN-NEXT:    s_cmp_lg_u32 s4, 4
; GCN-NEXT:    v_cndmask_b32_e32 v0, 4.0, v0, vcc
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
; GCN-NEXT:    v_mov_b32_e32 v1, 0x40a00000
; GCN-NEXT:    s_cmp_lg_u32 s4, 5
; GCN-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
; GCN-NEXT:    v_mov_b32_e32 v1, 0x40c00000
; GCN-NEXT:    s_cmp_lg_u32 s4, 6
; GCN-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
; GCN-NEXT:    v_mov_b32_e32 v1, 0x40e00000
; GCN-NEXT:    s_cmp_lg_u32 s4, 7
; GCN-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; GCN-NEXT:    v_mov_b32_e32 v1, 0x41000000
; GCN-NEXT:    s_cselect_b64 vcc, 1, 0
; GCN-NEXT:    v_cndmask_b32_e32 v2, v1, v0, vcc
; GCN-NEXT:    v_mov_b32_e32 v0, s2
; GCN-NEXT:    v_mov_b32_e32 v1, s3
...
; GCN-NEXT:    buffer_store_byte v1, off, s[4:7], 0 offset:7
; GCN-NEXT:    buffer_store_byte v2, off, s[4:7], 0 offset:6
; GCN-NEXT:    buffer_store_byte v1, off, s[4:7], 0 offset:5
; GCN-NEXT:    buffer_store_byte v2, off, s[4:7], 0 offset:4
; GCN-NEXT:    buffer_load_ubyte v0, v0, s[4:7], 0 offen
